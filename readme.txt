...
= 0.5.1 =
* No change, due to a broken release.
...
= 0.4 =
* New feature: now the links can be opened in a new tab.
...
* Fixed some issues when the plugin is installed for the first time.
* Added new schuelervz icon. 
* Updated formfeed icon.
